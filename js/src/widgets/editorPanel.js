...
// TODO I do think this Panel should be in the Window, instead of in the HUD.
    ...
    $.EditorPanel.prototype = {
        ...
        template: Handlebars.compile([
            ...
            '<div class="button close" title="Close"><i class="fa fa-times fa-lg"></i></div>',
            '<div class="button position-toggle" title="Toggle position"><i class="fa fa-exchange fa-lg"></i></div>',
            '</div>',
            '<form>',
